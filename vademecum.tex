...
{\changefont{cmss}{bx}{n} Entrada:\ \ \ \ \ }\= El sermón de la 
montaña\footnotemark[1], Iglesia peregrina, Juntos como hermanos (estr. 2), \\
\> Vine a alabar, Somos la familia de Jesús. \\ \\

{\changefont{cmss}{bx}{n} Salmo:} \> 1 ant. 1 ``Feliz el hombre que siempre 
medita en la ley de Dios.'' (estr. 1, 2 o 3). \\ \\ 

{\changefont{cmss}{bx}{n} Ofrendas:} \> Coplas de Yaravi, Te ofrecemos Padre 
nuestro (vidala), \\
\> Pan de vida y bebida de luz, Toma Señor nuestra 
vida, Te presentamos. \\ \\

{\changefont{cmss}{bx}{n} Comunión:} \>  Queremos ser Señor\footnotemark[2], 
Como Cristo nos amó \footnotemark[3], Brilló la luz\footnotemark[3],\\
\> Cuerpo y Sangre de Jesús, Escondido, Simple oración. \\ \\

{\changefont{cmss}{bx}{n} Post-com.:} \> Adoremos a Dios, Alabe todo el mundo 
(Taizé),\\
\> El Señor es mi fortaleza (Taizé), Mirarte sólo a Tí.\\ 
\\

{\changefont{cmss}{bx}{n} Salida:} \> Vayan todos por el mundo\footnotemark[4], 
Anunciaremos tu reino Señor, Soy peregrino,\\
\> Simple oración, En medio de los pueblos. \\ \\
...
\footnotetext[1]{El texto corresponde a las Bienaventuranzas (Lc 6,20-26 o Mt 
5,1-12). }
\footnotetext[2]{Cfr. \emph{Queremos ser Señor} con las Bienaventuranzas y con 
la 2da. lectura (1 Cor 15,12.16-20) en su última estrofa. }
\footnotetext[3]{Hace referencia a Jn 3,16 (antífona de comunión del día).}
\footnotetext[4]{Va muy bien con los primeros versículos del evangelio del día
(institución de los Apóstoles, Lc 6,12-13).}
...
\begin{center}
{\large\it El amor a los enemigos }
\end{center}
...
{\changefont{cmss}{bx}{n} Entrada:\ \ \ \ \ }\= El Señor nos 
llama\footnotemark[1], Vienen con alegría, Caminaré,$\,$Juntos como hermanos 
(est.$\,$2),\\
\> Vine a alabar. \\ \\

{\changefont{cmss}{bx}{n} Salmo:} \> 102 ant. 2 ``El amor del Señor permanece 
para siempre.'' (estr. 1, 2, 4, 5 o 6). \\ \\ 

{\changefont{cmss}{bx}{n} Ofrendas:} \> Señor te ofrecemos\footnotemark[2], 
Ofrenda de amor, Coplas de Yaravi, \\
\> Pan de vida y bebida de luz, Te presentamos. \\ \\

{\changefont{cmss}{bx}{n} Comunión:} \>  Simple oración\footnotemark[3], 
Queremos ser Señor\footnotemark[3], Jesucristo danos  de este pan,\\
\> Como Cristo nos amó, Bendigamos al Señor. \\ \\

{\changefont{cmss}{bx}{n} Post-com.:} \> Las misericordias del Señor 
(Taizé)\footnotemark[2], Si el mismo pan comimos, Adoremos a Dios,\\
\> Alabe todo el mundo (Taizé), Mirarte sólo a Tí.\\ 
\\

{\changefont{cmss}{bx}{n} Salida:} \> Santa María del camino, Mi camino eres Tú, 
Simple oración,\\
\> En medio de los pueblos. \\ \\
...
\footnotetext[1]{\emph{El Señor nos llama} (est.1) dice ``por todos [los 
caminos] hemos visto señales d etu amor''.}
\footnotetext[2]{Este canto es especial para este día porque insiste con la
pregunta ``tus misericordias, ?`quién podrá cantar?'' }
\footnotetext[3]{El texto es compatible con el evangelio del día (Lc 6,27-38 o 
Mt 5,38-48).}
...
\begin{center}
{\large\it La misericordia y la benevolencia para juzgar }
\end{center}
...
{\changefont{cmss}{bx}{n} Entrada:\ \ \ \ \ }\= Vienen con alegría,$\,$Iglesia 
peregrina,$\,$Juntos como hermanos (est.$\,$2),$\,$Vine a alabar. \\ \\

{\changefont{cmss}{bx}{n} Salmo:} \> 1 ant. 1 ``Feliz el hombre que siempre 
medita...'' (estr. 1, 2, o 3). \\ \\ 

{\changefont{cmss}{bx}{n} Ofrendas:} \> Al altar nos acercamos\footnotemark[1], 
Los frutos de la tierra\footnotemark[1], Coplas de Yaravi\footnotemark[2],\\
\>Pan de vida y bebida de luz. \\ \\

{\changefont{cmss}{bx}{n} Comunión:} \>  Dios me dio a mi 
hermano\footnotemark[1], Queremos ser Señor\footnotemark[1], Simple 
oración\footnotemark[1], \\
\> Coplas de Yaravi\footnotemark[2], Jesucristo danos  
de este pan, Cuerpo y Sangre de Jesús,\\
\> Bendigamos al Señor.\\ \\

{\changefont{cmss}{bx}{n} Post-com.:} \> El alfarero (Vaso 
nuevo)\footnotemark[2], Adoremos a Dios\footnotemark[3], Las misericordias del 
Señor (Taizé), \\
\> Si el mismo pan comimos, Mirarte sólo a Tí.\\ 
\\

{\changefont{cmss}{bx}{n} Salida:} \> Por ti mi Dios\footnotemark[2], Canción 
del Misionero\footnotemark[4], Vayan todos por el mundo\footnotemark[4], \\
\> Santa María del camino, Cantad a María. \\ \\
...
\footnotetext[1]{Estos cantos usan la imagen de ``los frutos'' que aparece en el
evangelio del día (Lc. 6, 39-45).}
\footnotetext[2]{Está en consonancia con la primera lectura Ecli. 27,5 y Ecli 
27,5-6. }
\footnotetext[3]{Cfr. 1 Cor 15,51.}
\footnotetext[4]{Cfr. Mt 28,20 (antífona de comunión del día).}
...
\begin{center}
{\large\it Curación del sirviente de un centurión }
\end{center}
...
{\changefont{cmss}{bx}{n} Entrada:\ \ \ \ \ }\= Pueblo de Dios, Vine a 
alabar, Vienen con alegría, Vine a alabar. \\ \\

{\changefont{cmss}{bx}{n} Salmo:} \> 65 ant. 1 ``Todo el mundo cante la gloria 
de Dios...'' (estr. 1, 2). \\
\> (antífona de reemplazo: Sal 144 ant. 1 ``Te alabamos, Señor,...'') \\ \\ 

{\changefont{cmss}{bx}{n} Ofrendas:} \> Padre nuestro recibid\footnotemark[1], 
Bendito seas, Te ofrecemos Padre nuestro (vidala),\\
\>Pan de vida y bebida de luz. \\ \\

{\changefont{cmss}{bx}{n} Comunión:} \>  Oh buen Jesús\footnotemark[2], Cuerpo 
y Sangre de Jesús\footnotemark[2], Más cerca a oh Dios, \\
\> Es mi Padre, Bendeciré al Señor.\\ \\

{\changefont{cmss}{bx}{n} Post-com.:} \> Adoremos a Dios, Tan cerca de mí, 
Mirarte sólo a Tí.\\ \\

{\changefont{cmss}{bx}{n} Salida:} \> Vayan todos por el 
mundo\footnotemark[3], Por ti mi Dios, Mi camino eres Tú,  \\
\> Santa María del camino, Oh María. \\ \\
...
\footnotetext[1]{Glorifica a Dios en su última estrofa (en consonancia con la 
obra del Señor en Lc. 7,1-10.}
\footnotetext[2]{Está en consonancia con las palabras del centurión (Lc. 
7,1-10) cuando proclama ``indigno soy''.   }
\footnotetext[3]{El estribillo coincide con la antífona del salmo del día 
...
\section*{\small Despertemos llega Cristo} \noindent\footnotesize El texto de 
este canto es de Osvaldo Catena. La melod\'\i a corresponde al espiritual 
negro \emph{He's the lily of the valley, oh my Lord}. La melodía es de autor 
(o autores) desconocido y se consigna como parte del repertorio del grupo a 
capella \emph{The Jubilee Singers} de la Fisk University. La partitura y la 
historia del grupo se encuentra registrada en la edici\'on de 1880 de 
\emph{The Story of the Jubilee Singers}, por J. B.T. Marsh. El títúlo de la 
melodía (y el estribillo) corresponde a Cant. 2,1. Dice ``Yo soy el narciso de 
Sarón, el lirio de los valles'', que muchos exegetas interpretan como Cristo y 
su Iglesia. El P. Osvaldo Catena escribió un texto para el tiempo de Adviento 
basado en Rom. 13,11 (1$^\circ$ domingo de Adviento, ciclo A). Su texto es muy 
apropiado y sintoniza muy bien con el título de la melodía, ya que Cant 2,8-14 
se lee en la liturgia de Adviento del 21 de diciembre.   
\iffalse
El texto de este canto es de Osvaldo Catena. La melod\'\i a del estribillo es 
una variaci\'on del espiritual negro \emph{Lord, I want to be a Christian}, 
posiblemente realizada por Osvaldo Catena para adaptarla mejor el texto en 
espa\~nol. La melod\'\i a apareci\'o publicada en \emph{Folk Songs of the 
American Negro} (1907), compilada por los hermanos Frederick Work y John W. 
Work, Jr. Tambi\'en se encuentra en la edici\'on de 1918 de \emph{Religious Folk 
Songs of the Negro as Sung on the Plantations}, arreglada por los directores 
musicales del \emph{Hampton Normal and Agricultural Institute}, Hampton, 
Virginia. M\'as recientemente, apareci\'o publicado en \emph{American Negro 
Songs: 230 folk songs and spirituals, religious and secular} de John Wesley Work 
III (1940).  En \emph{Negro Slave Songs in the United States} (1953), Miles Mark 
Fisher sugiere que este \emph{spiritual} podr\'\i a haberse originado en 
Virginia alrededor de 1750 debido a 
